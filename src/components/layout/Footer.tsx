      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="font-semibold text-gray-900">BazeConnect</p>
              <p className="text-xs text-gray-500">Campus Social Network</p>
            </div>
          </div>
        ...
        <div className="mt-4 pt-4 border-t border-gray-100 text-center text-xs text-gray-500">
          <p>© 2024 BazeConnect. All rights reserved. | A Project for Baze University, Abuja</p>
        </div>
      </div>
    </footer>
  )
